...
public:
    ...
    void setupUi(QWidget *Widget)
    {
        ...
        NombreWifi->setObjectName("NombreWifi");
        NombreWifi->setGeometry(QRect(290, 30, 341, 22));
        ContraseniaWifi = new QLineEdit(Widget);
        ContraseniaWifi->setObjectName("ContraseniaWifi");
...
"selection-background-color: rgb(255, 175, 175);"));
        ...
        btnAlarmaGas->setObjectName("btnAlarmaGas");
...
"max-height: 24px;"));
        ...
        btnNivelBajo->setObjectName("btnNivelBajo");
...
"    max-height: 48px;"));
        ...
        btnNivelMedio->setObjectName("btnNivelMedio");
...
"    max-height: 48px;"));
        ...
        btnNivelAlto->setObjectName("btnNivelAlto");
